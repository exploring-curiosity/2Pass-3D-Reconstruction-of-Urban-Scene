...
\midrule
\textbf{Total (per frame)} & \textbf{54ms} \\
\textbf{Throughput} & \textbf{18.5 FPS} \\
\bottomrule
\end{tabular}
\end{table}

The system achieves near real-time performance, processing a 5-minute video in under 1 minute, making it practical for both offline safety audits and potential real-time monitoring applications.
