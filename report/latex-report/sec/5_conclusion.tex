...
\begin{itemize}
    ...
    \item Sub-meter 3D localization accuracy (0.42m vehicles, 0.28m pedestrians) is achieved through depth-enhanced projection
\end{itemize}
